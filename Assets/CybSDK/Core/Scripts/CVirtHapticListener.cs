...
namespace CybSDK
{
    ...
    public class CVirtHapticListener : MonoBehaviour
    {
        ...
        private void OnCVirtDeviceControllerCallback(UVirtDevice virtDevice, CVirtDeviceController.CVirtDeviceControllerCallbackType callbackType)
        {
        ...
        void Update()
        {
            UVirtDevice virtDevice = deviceController.GetDevice();
